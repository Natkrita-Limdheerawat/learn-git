...
# --- ฟังก์ชันจากรูปที่ 2 (ส่วนที่คุณขอมา) ---
...
def date_diff(date1, date2):
    ...
    # กรณีคนละปี
    # 1. วันที่เหลือในปีแรก (นับรวมวันเริ่มต้นด้วย +1)
    days = day_in_year(y1) - day_of_year(d1, m1, y1) + 1
    
    # 2. วันทั้งหมดในปีระหว่างกลาง
    for year in range(y1 + 1, y2):
        days += day_in_year(year)
        
    # 3. วันที่ผ่านไปในปีสุดท้าย
    days += day_of_year(d2, m2, y2)
    
    return days

# ทดสอบการทำงาน
print(date_diff("25-12-1999", "9-3-2000")) # ผลลัพธ์: 76